...
5. Rename the extracted folder from `super-engineering-devops-main` to `super-engineering-devops`.
6. Copy the renamed `super-engineering-devops` folder into your agent's skills directory.
...
This repository is the `super-engineering-devops` skill. Keep the full `super-engineering-devops` folder together when installing it.
